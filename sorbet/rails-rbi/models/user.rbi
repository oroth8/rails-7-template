...
module User::GeneratedAttributeMethods
  ...
  sig { returns(T::Boolean) }
  def main_address; end

  sig { params(value: T::Boolean).void }
  def main_address=(value); end
...
module User::GeneratedAssociationMethods
  ...
  sig { params(args: T.untyped, block: T.nilable(T.proc.params(object: ::Unit).void)).returns(::Unit) }
  def build_unit(*args, &block); end

  sig { params(args: T.untyped, block: T.nilable(T.proc.params(object: ::Unit).void)).returns(::Unit) }
  def create_unit(*args, &block); end
...
class User < ApplicationRecord
  ...
  sig { params(args: T.untyped).returns(User::ActiveRecord_Relation) }
  def self.guest(*args); end

  sig { params(args: T.untyped).returns(User::ActiveRecord_Relation) }
  def self.not_admin(*args); end

  sig { params(args: T.untyped).returns(User::ActiveRecord_Relation) }
  def self.not_guest(*args); end

  sig { params(args: T.untyped).returns(User::ActiveRecord_Relation) }
  def self.not_owner(*args); end

  sig { params(args: T.untyped).returns(User::ActiveRecord_Relation) }
  def self.not_standard(*args); end

  sig { params(args: T.untyped).returns(User::ActiveRecord_Relation) }
  def self.owner(*args); end

  sig { params(args: T.untyped).returns(User::ActiveRecord_Relation) }
  def self.standard(*args); end

  sig { returns(T.nilable(User::Role)) }
  def typed_role; end

  sig { params(value: T.nilable(User::Role)).void }
  def typed_role=(value); end

  class Role < T::Enum
    enums do
      Guest = new(%q{guest})
      Standard = new(%q{standard})
      Owner = new(%q{owner})
      Admin = new(%q{admin})
    end
...
class User::ActiveRecord_Relation < ActiveRecord::Relation
  ...
  sig { params(args: T.untyped).returns(User::ActiveRecord_Relation) }
  def not_guest(*args); end

  sig { params(args: T.untyped).returns(User::ActiveRecord_Relation) }
  def not_owner(*args); end

  sig { params(args: T.untyped).returns(User::ActiveRecord_Relation) }
  def not_standard(*args); end

  sig { params(args: T.untyped).returns(User::ActiveRecord_Relation) }
  def owner(*args); end

  sig { params(args: T.untyped).returns(User::ActiveRecord_Relation) }
  def standard(*args); end
end
